...
public static class ServiceFactory
{
    ...
    public static ServiceProvider GetServiceProvider()
    {
        ...
        // Register validators from the assembly containing the UpdateUserConnectionIdCommandValidator.
        services.AddValidatorsFromAssemblyContaining<UpdateUserConnectionIdCommandValidator>();

        // Register MediatR and register services from the assembly containing UpdateUserConnectionIdCommand.
        services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(UpdateUserConnectionIdCommand).Assembly));
