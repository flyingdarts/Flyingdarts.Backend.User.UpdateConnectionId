...
{
    // Convert the APIGatewayProxyRequest to the specified UpdateUserConnectionIdCommand type using the serializer
    var socketRequest = request.To<UpdateUserConnectionIdCommand>(serializer);
